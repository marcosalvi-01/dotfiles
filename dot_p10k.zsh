...
() {
  ...
  ##################################[ dir: current directory ]##################################
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR_FOREGROUND=39
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=206
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=206
